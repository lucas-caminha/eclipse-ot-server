...
function rewardsInfo.onSay(player, words, param)
	local text = "Eclipse OT Level Rewards\n\n"
		...
		.. "Sorcerer/Druid: levels 40, 50, 60, 75, 80, 100, 130, 150, 180, 200 and 220.\n"
		.. "Paladin: levels 50, 60, 80, 100, 120, 150, 180, 200 and 220.\n"
		.. "Knight: levels 40, 50, 75, 80, 100, 130, 150, 180, 200 and 225.\n"
		.. "Monk: levels 40, 50, 70, 80, 100, 125, 135, 150, 180, 200 and 250.\n\n"
		.. "Common milestones:\n"
