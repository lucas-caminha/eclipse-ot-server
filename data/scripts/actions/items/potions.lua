...
local potions = {
	[236] = { health = { 250, 350 }, vocations = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.KNIGHT, VOCATION.BASE_ID.MONK }, level = 20, flask = 283, description = "Only knights, paladins and monks of level 20 or above may drink this fluid." },
	[237] = { mana = { 115, 185 }, level = 20, flask = 283, description = "Only players of level 20 or above may drink this fluid." },
	[238] = { mana = { 150, 250 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID, VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.MONK }, level = 50, flask = 284, description = "Only sorcerers, druids, paladins and monks of level 50 or above may drink this fluid." },
	[239] = { health = { 425, 575 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 50, flask = 284, description = "Only knights of level 50 or above may drink this fluid." },
	...
	[7642] = { health = { 250, 350 }, mana = { 100, 200 }, vocations = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.MONK }, level = 50, flask = 284, description = "Only paladins and monks of level 50 or above may drink this fluid." },
	[7643] = { health = { 650, 850 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 100, flask = 284, description = "Only knights of level 100 or above may drink this fluid." },
	[7644] = { combat = antidote, flask = 285 },
	[7876] = { health = { 60, 90 }, flask = 285 },
	[23373] = { mana = { 425, 575 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID }, level = 100, flask = 284, description = "Only druids and sorcerers of level 100 or above may drink this fluid." },
	[23374] = { health = { 420, 580 }, mana = { 250, 350 }, vocations = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.MONK }, level = 100, flask = 284, description = "Only paladins and monks of level 100 or above may drink this fluid." },
	[23375] = { health = { 875, 1125 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 150, flask = 284, description = "Only knights of level 150 or above may drink this fluid." },
