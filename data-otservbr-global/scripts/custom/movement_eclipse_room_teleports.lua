...
local teleports = {
	...
	{ name = "Temple water vortex to trainers", from = Position(32365, 32239, 7), to = Position(1182, 1047, 7) },
	{ name = "Trainers water vortex to temple", from = Position(1184, 1047, 7), to = Position(32369, 32241, 7) },
