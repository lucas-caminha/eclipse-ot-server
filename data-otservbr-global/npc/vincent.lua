...
npcConfig.shop = {
	...
	{ itemName = "crystal bolt", clientId = 15792, buy = 20 },
	{ itemName = "crystalline arrow", clientId = 15793, buy = 20 },
	{ itemName = "diamond arrow", clientId = 35901, buy = 130 },
	{ itemName = "drill bolt", clientId = 16142, buy = 12 },
	{ itemName = "earth arrow", clientId = 774, buy = 5 },
	{ itemName = "enchanted spear", clientId = 7367, buy = 15 },
	{ itemName = "envenomed arrow", clientId = 16143, buy = 12 },
	{ itemName = "flaming arrow", clientId = 763, buy = 5 },
	{ itemName = "flash arrow", clientId = 761, buy = 5 },
	{ itemName = "glooth spear", clientId = 21158, buy = 100 },
	{ itemName = "hunting spear", clientId = 3347, buy = 25 },
	{ itemName = "infernal bolt", clientId = 6528, buy = 15 },
	{ itemName = "onyx arrow", clientId = 7365, buy = 7 },
	{ itemName = "piercing bolt", clientId = 7363, buy = 5 },
	{ itemName = "poison arrow", clientId = 3448, buy = 5 },
	...
	{ itemName = "simple arrow", clientId = 21470, buy = 3 },
